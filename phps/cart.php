...
if(!empty($_SESSION["shopping_cart"])){
    ...
    $total_price = $total_price + (int)$sp['discount']*$sp['weight'];
    }
}
                        ...
                        foreach($_SESSION["shopping_cart"] as $product){
                            ...
                            <div class='row '>
                              <div class='row main align-items-center d-flex justify-content-evenly col-12'>
                                ...
                                <div class='col-5'>
                                <div class='row text-muted  fs-5   '>Price =". $product["discount"]."Rs/Kg </div>
                                  <div class='row text-muted  fs-5  '>Quantity =". $product["weight"]." Kg </div>
                   ...
                   echo "
                    ...
                    <div class=' summary  justify-content-center'>
                      ...
                      <input type='hidden' name='total_price' value='".$total_price."'>
                        ...
                        <div class='col'></div>
                        <div class='text-center'><h5 class='text-center'> PRODUCT PRICE =  &#8377; ".(($total_price) ? $total_price: '00' ). "</h5> 
                        </div><div class='text-center'><h5 class='text-center'> TAX PRICE =  &#8377; ".(($tax) ? $tax: '00' ). "</h5> </div>
                        </div >
                        <div class='text-center'><h2 class='text-center'> TOTAL PRICE =  &#8377; ".(($total_price+$tax) ? $total_price+$tax: '00' ). "</h2></div>
                        </div >
                        <button type='submit' class='btn btn-dark mb-3 w-25' ".(($isempty) ? "disabled" : " " )." style='display: block;margin:auto;'>CHECKOUT</button>
                        </form>
                </div>
            </div>
