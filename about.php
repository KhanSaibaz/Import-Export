...
<html lang="en">
  ...
  <header id="header" class="fixed-top">
    ...
    <section id="about" class="about" style="margin-top: 72px;">
      <div class="container">

        <div class="row">
          <div class="col-lg-6">
            <img src="images/abouts1.jpg" class="img-fluid w-100 h-100" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <h3>IMPORT EXPORT FRUITS</h3>
            <p class="fst-italic">
              Import-export made effortless.Beyond borders, beyond expectations: Your trusted import-export partner.Navigating the complexities of global trade
            </p>
            <ul>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>G NO 55/4 P NO 3,, Kurla, Mumbai, Maharashtra - 423203</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>khansaibaz2121@gmail.com</p>
              </div>
